...
Location.prototype.get_author=function() {
  const match=this.href.match(/~([^/]+)/);
  return match?match[1]:ADMIN;
  }
Location.prototype.get_path=function() {
  var path=window.location.pathname.replace(/^\/~pippo/,"");
  if(path[path.length-1]=="/") path=path+"index.xhtml";
  return path.substring(1);
  }


ADMIN="ferri-emanuele";

CMS="/cms";
NO_IMAGE_SRC=CMS+"/no_image.svg";

CORE_SCRIPT=CMS+"/core.js";
CORE_STYLE=CMS+"/core.css";

LOGIN_SCRIPT=CMS+"/login.php";
LOGOUT_SCRIPT=CMS+"/logout.php";
LOGGED_SCRIPT=CMS+"/logged.php";

REGISTER_REQUEST_SCRIPT=CMS+"/register_request.php";
PASSWORD_RESET_REQUEST_SCRIPT=CMS+"/password_reset_request.php";
PASSWORD_RESET_CONFIRM_SCRIPT=CMS+"/password_reset_confirm.php";
PASSWORD_CHANGE_SCRIPT=CMS+"/password_change.php";
EMAIL_CHANGE_REQUEST_SCRIPT=CMS+"/email_change_request.php";
ACCOUNT_DELETE_REQUEST_SCRIPT=CMS+"/account_delete_request.php";

EMAIL_CHECK_SCRIPT=CMS+"/email_check.php";
USERNAME_CHECK_SCRIPT=CMS+"/username_check.php";
PASSWORD_CHECK_SCRIPT=CMS+"/password_check.php";

COPY_SCRIPT=CMS+"/copy.php";
MOVE_SCRIPT=CMS+"/move.php";
MAKE_DIR_SCRIPT=CMS+"/make_dir.php";
PUBLISH_SCRIPT=CMS+"/publish.php";
UNPUBLISH_SCRIPT=CMS+"/unpublish.php";
TRASH_SCRIPT=CMS+"/trash.php";
DELETE_SCRIPT=CMS+"/delete.php";

FILE_EXPLORER_SCRIPT=CMS+"/file_explorer.php";
GROUPS_SCRIPT=CMS+"/groups.php";
FILE_BROWSER_SCRIPT=CMS+"/file_browser.php";
SAVE_SCRIPT=CMS+"/save.php";
UPLOAD_SCRIPT=CMS+"/upload.php";

REGISTER_REQUEST_MESSAGE=CMS+"/register_request.txt";
PASSWORD_RESET_REQUEST_MESSAGE=CMS+"/password_reset_request.txt";
PASSWORD_RESET_CONFIRM_MESSAGE=CMS+"/password_reset_confirm.txt";
PASSWORD_CHANGE_MESSAGE=CMS+"/password_change.txt";
EMAIL_CHANGE_REQUEST_MESSAGE=CMS+"/email_change_request.txt";
ACCOUNT_DELETE_REQUEST_MESSAGE=CMS+"/account_delete_request.txt";
FILE_ERROR_MESSAGE=CMS+"/file_error.txt";
  ...
  "desktop":
    ...
    "sons":[
      ...
      "nomen":"login",
    	...
    	"tag":"launcher",
      "nomen":"page",
    	"source":window.location.get_path()
    	},
      {
    	"tag":"launcher",
      "nomen":"toolbox",
...
_toolbox=
  ...
  "sons":[
    ...
    {
    "tag":"launcher",
    "sons":["horizontal_panel"],
    "source":[{"tag":"horizontal_panel"}]
    },
    {
    "tag":"launcher",
    "sons":["vertical_box"],
    "source":[{"tag":"vertical_box"}]
    },
    {
    "tag":"launcher",
    "sons":["dropdown"],
    ...
    "source":[{"tag":"border_layout"}]
   	...
   	{
    "tag":"launcher",
    "sons":["two_column_layout"],
    "source":[{"tag":"two_column_layout"}]
    },
   	{
    "tag":"launcher",
    "sons":["three_column_layout"],
    "source":[{"tag":"three_column_layout"}]
    },
   	{
    "tag":"launcher",
    "sons":["four_column_layout"],
    "source":[{"tag":"four_column_layout"}]
    },
    {
    "tag":"launcher",
    "sons":["five_column_layout"],
    "source":[{"tag":"five_column_layout"}]
    },
    {
    "tag":"launcher",
    "sons":["top_bar_layout"],
    "source":[{"tag":"top_bar_layout"}]
    },
    {
    "tag":"launcher",
    "sons":["left_bar_layout"],
    "source":[{"tag":"left_bar_layout"}]
    },
   	{
    "tag":"launcher",
    "sons":["right_bar_layout"],
    "source":[{"tag":"right_bar_layout"}]
    },
    {
    "tag":"launcher",
    "sons":["bottom_bar_layout"],
    "source":[{"tag":"bottom_bar_layout"}]
    },
   	{
    "tag":"launcher",
    "sons":["slideshow"],
...
_password_reset_request={
  ...
  "container":{
    "message":{
      "sons":PASSWORD_RESET_REQUEST_MESSAGE
      }
    }
  }
...
_password_reset_confirm={
  ...
  "container":{
    "message":{
      "sons":PASSWORD_RESET_CONFIRM_MESSAGE
      }
    }
  }
...
_email_change_request={
  ...
  "container":{
    "message":{
      "sons":EMAIL_CHANGE_REQUEST_MESSAGE
      }
    }
  }
...
_account_delete_request={
  ...
  "container":{
    "message":{
      "sons":ACCOUNT_DELETE_REQUEST_MESSAGE
      }
    }
  }
...
_file_browser={
  ...
  "container":
    {
    "sons":FILE_BROWSER_SCRIPT,
    "parameters":
      {
      "users":[window.location.get_author()]
      }
    }
  };
...
function random_string() {
  return Date.now().toString()+Math.floor(Math.random() * Number.MAX_SAFE_INTEGER).toString();
  }

open_in_win=function(jsons,win_json){
  var win=document.body.wins.insert("standard_win",win_json);
  win.container.insert_jsons(jsons);
  return win;
  }

load_in_win=async function(url,post_json,win_json){
  var jsons=await load(url,post_json);
  if(jsons) return open_in_win(jsons,win_json);
...
String.prototype.dirname_slash_stem=function() {
...
Element.prototype.get_win=function(){
  var node=this;
  while(node&&!node.isa("win")) node=node.parentNode;
  return node;
  }
...
Element.prototype.to_json=function(include_excluded_in_json=this.include_excluded_in_json,p=el(this.get_tag())){
  ...
  var deep=(typeof this.sons!='string' && this.sons!==false && !p.sons);   //you can stop to_json also by set sons=false
...
Element.prototype.insert_jsons=async function(jsons=[],next){
  if(typeof jsons=="string"){
    this.set_parameters();
    jsons=await load(jsons,this.parameters);
    }
...
addEventListener("load",
  async function(e){
    ...
    document.body.wins.insert("standard_win",{"author":window.location.get_author(),"path":window.location.get_path(),"fullscreen":true}).container.insert_jsons(jsons);
...
merge=function(h1={},h2={}){
  ...
  for(var key in h2){
    ...
    //else if(Array.isArray(result[key]) && Array.isArray(h2[key])) result[key]=result[key].concat(h2[key]);
...
page_title=function(a){
  var o=el("h1",a);
  o.addEventListener("attached",
    function(e){
      var author=o.get_win().author;
      var title=author==""?window.location.get_author():author;
      o.set_text(title);
      }
    );
  return o;
...
column_layout=function(a){
  return el("layout",a);
  }
two_column_layout=function(a){
  var o=el("column_layout",a);
  o.ins("box0","box");
  o.ins("box1","box");
  return o;
  }
three_column_layout=function(a){
  var o=el("column_layout",a);
  o.ins("box0","box");
  o.ins("box1","box");
  o.ins("box2","box");
...
top_bar_layout=function(a){
  return el("bar_layout",a);
  }
right_bar_layout=function(a){
  return el("bar_layout",a);
  }
left_bar_layout=function(a){
  return el("bar_layout",a);
  }
bottom_bar_layout=function(a){
  return el("bar_layout",a);
  }
...
standard_win=function(a){
  ...
  o.ins("save_win","win");
  o.save_win.container.ins("login","login");
  ...
  o.set_file_info=function(){
    var author=o.author;
    var dirname=o.path.dirname();
    var dirname_slash_stem=o.path.dirname_slash_stem();
    var stem=o.path.stem();
    var extname=o.path.extname();
    o.title_bar.path.set_text(dirname_slash_stem);
    o.title_bar.path.set("title",extname)
    o.title_bar.author.set_text(author);
    if(o.author==document.body.logged) o.save_win.container.file_saver.folder.set("value",dirname);
    o.save_win.container.file_saver.file.set("value",stem);
  ...
  o.save_win.container.file_saver.save_button.addEventListener("click",
    async function(e){
      ...
      if(saved){
        var fs=o.save_win.container.file_saver;
        o.set("author",document.body.logged);
        o.set("path",fs.folder.value+fs.file.value+fs.ext.value);
        o.set_file_info();
        }
      }
    );
...
file_manager=function(a){
  ...
  o.group_browser.container.addEventListener("attach",
    function(e){
      var users=o.file_browser.container.parameters["users"];
      if(users){
  ...
  o.group_browser.container.addEventListener("click",
    function(e){
      ...
      var parameters=clone(o.file_browser.container.parameters);
      parameters.users=selected;
      o.file_browser.container.set("parameters",parameters);
...
style_master=function(a){
  var o=el("vertical_box",merge(a,{"sons":false}));
  ...
  o.remove_style=function(){
    ...
    if(selected_style){
      if(selected_style.get_href()!=CORE_STYLE){
  ...
  o.up_style=function(){
    var selected_style=o.get_selected_style();
    if(selected_style){
      var prev=selected_style.previousElementSibling;
      if(prev&&prev.tagName=="link"&&prev.get_href()!=CORE_STYLE){
  ...
  o.down_style=function(){
    var selected_style=o.get_selected_style();
    if(selected_style){
      var next=selected_style.nextElementSibling;
      if(next&&next.tagName=="link"&&next.get_href()!=CORE_STYLE){
...
labelled_input=function(a){
  ...
  o.ins("input","input");
  o.ins("message","div");
  o.check_input=async function(){
    if(o.check_script){
      var error=await load_json(o.check_script,{"data":o.input.value});
      o.set('error',error);
      }
    }
...
form_box=function(a){
  ...
  o.clear_form=function(){
    for(var child of o.container.children) if(child.isa("labelled_input")) child.input.set("value","");
    }
...
submitter=function(a){
  ...
  o.submit_button.addEventListener("click",
    async function(e){
      if(o.no_errors()){
        await load_in_win(o.submit_script,o.get_values());
        o.clear_form();
        }
      }
    );
...
file_explorer=function(a){
  ...
  o.toolbar.ins("make_dir_button","button");
  ...
  o.container.set_parameters=function(){
    this.set("parameters",{"folder":o.folder.value,"trashed":o.trashed});
    };
        ...
        if(child.is_folder){
          ...
          child.addEventListener("click",
            async function(e){
              e.stopPropagation();
              e.preventDefault();
              var public_file="."+random_string()+child.path.extname();
              var moved=await load_json(o.move_script,{"source":child.path,"dest":public_file});
              if(!child.readable) await load_json(o.publish_script,{"path":public_file});
              load_in_win("/~"+child.author+"/"+public_file,child.parameters,{"author":child.author,"path":child.path});
              if(!child.readable) await load_json(o.unpublish_script,{"path":public_file});
              load_json(o.move_script,{"source":public_file,"dest":child.path});
              }
            );
          }
        }
  ...
  o.dialog_execute=async function(action,stem,ext=""){
    ...
    if(response){
      var result=await load_json(action,{"path":response});
      if(!result) load_in_win(o.file_error);
      }
    await document.body.wins.reload();
    }
  o.repeat_dialog_execute=async function(action){
    ...
    for(source of o.sources){
      ...
      var response=await document.body.path_dialog.get_value();
      if(response){
        var result=await load_json(action,{"source":source,"dest":response});
        if(!result) load_in_win(o.file_error);
  ...
  o.toolbar.move_button.addEventListener("click",
    function(e){
      o.repeat_dialog_execute(o.move_script);
      }
    );
  ...
  o.toolbar.make_dir_button.addEventListener("click",
    async function(e){
      o.dialog_execute(o.make_dir_script,"New folder");
      }
    );
  ...
  o.toolbar.make_dir_button.title="New folder";
  ...
  o.save=async function(e){
    if(o.file.value!=""){
      ...
      try{
        ...
        var result=await load_json(o.save_script,parameters);
        if(!result) load_in_win(o.file_error);
  ...
  o.upload_button.addEventListener("click",
    async function(e){
      if(o.file.value!=""&&o.datafile.files.length>0){
        ...
        var result=await load_json(o.upload_script,data);
        if(!result) load_in_win(o.file_error);
        document.body.wins.reload();
        }
      }
...
a=function(a){
  ...
  o.addEventListener("click",
    function(e){
      e.preventDefault();
      if(o.active) load_in_win(o.get("href"),o.parameters,merge({"author":o.author,"path":o.path},o.win_attributes));
      }
    );
  return o;
  }
...
tursim=function(a){
  ...
  o.middle_step=function(){
    if(o.start){
      var read=o.center_value();
      var transition=o.start.get_transition(read);
      if(transition){
        o.link=o.get_link(o.start,transition.next);
        o.link.set('selected',true);
        }
      }      
    }
  o.step=function(){
    if(o.link){
      o.link.set('selected',false);
      o.link=null;
      }
    if(o.start){
  ...
  o.title_bar.fsa.addEventListener("click",
    function(e){
      if(o.is_fsa()){
        o.set("write",false);
        o.set("move",false);
  ...
  o.title_bar.step.addEventListener("mousedown",
    function(e){
      o.middle_step();
      }
    );
  o.title_bar.step.addEventListener("mouseup",
    function(e){
      o.step();
      }
    );
